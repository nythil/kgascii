...
#ifndef KGUTIL_RESAMPLE_FILTER_TRIANGLE_HPP
#define KGUTIL_RESAMPLE_FILTER_TRIANGLE_HPP
...
struct TriangleFilter: public std::unary_function<TReal, TReal>
{
...
#endif // KGUTIL_RESAMPLE_FILTER_TRIANGLE_HPP
